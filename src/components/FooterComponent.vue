    ...
    <footer class="footer">
        <div class="footer__inner">
            <div class="footer__social">
                <a class="footer__logo" href="index.html"><img class="footer__logo-image"
                        :src="require('@/assets/img/logo.png')" /></a>
                <p class="footer__social-text">
                    It is a long established fact that a reader will be distracted
                    lookings.
                </p>

                <ul class="footer__social-icons-box">
                    <li class="footer__social-icon-item">
                        <svg class="footer__social-icon-link" width="19" height="16" viewBox="0 0 19 16" fill="none"
                    ...
                    <li class="footer__social-icon-item">
                        <svg class="footer__social-icon-link" width="17" height="16" viewBox="0 0 17 16" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <nav class="footer__menu">
                <h3 class="footer__menu-heading">Pages</h3>
            ...
            <div class="footer__contact">
                ...
                <div class="footer__contact-box">
                    ...
                    <p class="footer__contact-email">contact@interno.com</p>
                    <p class="footer__contact-tel">(123) 456 - 7890</p>
                </div>
            </div>
        </div>
    </footer>
